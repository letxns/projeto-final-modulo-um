function caminhoPairulito(){
    ...
    caminhoPairulito.addEventListener("click", function(){
    var comida = prompt("Qual comida você deseja levar à festa? \n 1 → Bolo \n 2 → Tiramisu \n 3 → Torta de limão");
    while(true){
        if(comida == 1){
            window.location="pairulito-bolo.html";
...
function caminhoBoloUm(){
    ...
    while(true){
    if(bolo == 1){
            window.location="bolo-um-um.html"; 
            event.preventDefault()
        } else if(bolo == 2){
...
function caminhoTiramisu() {
    ...
    while(true){
    if(tiramisu == 1){
            window.location="tiramisu-um.html"; 
            event.preventDefault()
        } else if(tiramisu == 2){
...
function caminhoTorta() {
    ...
    while(true){
    if(torta == 1){
            window.location="pairulito-torta-de-limao-um.html";
            event.preventDefault()
        } else if(torta == 2){
