...
function caminhoRigby(){
    ...
    while(true){
        if(comida == 1){
            window.location="rigby-mac-n-cheese.html"; //abrir essa página antes de carregar os próximos prompts
...
function caminhoMacNChesse(){
    ...
    while(true){
    if(macnchesse == 1){
            window.location="mac-and-cheese-um.html"; //abrir essa página antes de carregar os próximos prompts
            event.preventDefault()
...
function chimichurri() {
    ...
    while(true){
    if(chimichurri == 1){
            window.location="chimichurri-um.html"; //abrir essa página antes de carregar os próximos prompts
            event.preventDefault()
